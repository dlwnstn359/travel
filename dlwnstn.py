...
st.dataframe(schedule_day1, hide_index=True)

# ✅ 2일차 일정
st.subheader("📅 2일차 일정")
schedule_day2 = pd.DataFrame({
...
st.dataframe(schedule_day2, hide_index=True)

# ✅ 3일차 일정
st.subheader("📅 3일차 일정")
schedule_day3 = pd.DataFrame({
...
st.dataframe(schedule_day3, hide_index=True)
